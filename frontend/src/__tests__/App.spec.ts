...
function creerRouteur(): Router {
  return createRouter({
    ...
    routes: [
      ...
      // Le profil du test est administrateur : sans ces routes, les liens
      // affichés par la barre ne se résolvent pas.
      { path: '/dashboard', name: 'dashboard', component: VUE_VIDE },
